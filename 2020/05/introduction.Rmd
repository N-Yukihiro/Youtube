...
gというデータフレームを作成し, write.csv()関数を利用して, dataフォルダにdata.csvというcsvファイルを作成してみましょう.
...
```{r}
write.csv(g, here("2020", "05", "data", "data.csv"), 
          quote=FALSE, row.names=FALSE)
```
...
もしくは
```{r}
dat1 <- read.csv(here("2020", "05", "data", "data.csv"), header = TRUE) 
```
...
もしくは
```{r}
dat2 <- readr::read_csv(here("2020", "05", "data", "data.csv"))
```
...
もしくは
```{r}
dat3 <- data.table::fread(here("2020", "05", "data", "data.csv"),
                          data.table = FALSE)
```
...
もしくは
```{r}
system.time(read.csv(here("2020", "05", "data", "data.csv")))
system.time(readr::read_csv(here("2020", "05", "data", "data.csv")))
system.time(data.table::fread(here("2020", "05", "data", "data.csv")))
```
...
dat2 <- readr::read_csv(here("2020", "05", "data", "data.csv"), 
                        locale=locale(encoding="UTF8"))
write.csv(dat2, here("2020", "05", "data", "data.csv"), 
          quote=FALSE, row.names=FALSE,
          fileEncoding = "UTF-8")
```
